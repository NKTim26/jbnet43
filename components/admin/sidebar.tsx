...
import { Sparkles, LayoutDashboard, Calendar, Users, FileText, Settings, LogOut, Menu, X } from "lucide-react"
    ...
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 flex h-16 items-center justify-between border-b border-sidebar-border bg-sidebar px-4 lg:hidden">
        <Link href="/admin" className="flex items-center gap-2">
          ...
          <span className="font-bold text-sidebar-foreground">JBNet43 Admin</span>
        </Link>
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="hidden h-16 items-center gap-2 border-b border-sidebar-border px-6 lg:flex">
            ...
            <div>
              ...
              <span className="ml-1 rounded bg-sidebar-accent px-1.5 py-0.5 text-xs text-sidebar-accent-foreground">Admin</span>
            </div>
          </div>
          ...
          <div className="p-4">
            <Link href="/">
              <Button variant="outline" className="w-full bg-sidebar-accent/50 border-sidebar-border text-sidebar-foreground hover:bg-sidebar-accent">
                Voir le site
              </Button>
            </Link>
          </div>
